...
try {
    ...
    // Tabela de Agendamentos atualizada com as novas colunas
    ...
    // Tenta adicionar as colunas caso a tabela já existisse de aulas anteriores (Evita erros de coluna duplicada)
    try {
    ...
    echo "<h3 style='color: green;'>🚀 Tudo pronto e atualizado!</h3>";
} catch (Exception $e) {
